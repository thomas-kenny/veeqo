...
Item.create(name: 'Board game', width: 300, depth: 300, height: 100, fragile: false, padding: 0, weight: 0)
Item.create(name: 'Picture frame', width: 100, depth: 250, height: 15, fragile: true, padding: 0, weight: 0)
Item.create(name: 'Candle', width: 148, depth: 210, height: 25, fragile: false, padding: 0, weight: 0)
Item.create(name: 'Book', width: 148, depth: 210, height: 25, fragile: false, padding: 0, weight: 0)
